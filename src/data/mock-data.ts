import { ShoppingCart, Car, Utensils, Home, Shirt, HeartPulse, Plus } from 'lucide-react';
import type { Wallet, Tag, Transaction } from '@/lib/types';

export const mockTags: Tag[] = [
  { id: '1', name: 'Mua sắm', icon: ShoppingCart, textColor: 'text-blue-500', bgColor: 'bg-blue-100' },
  { id: '2', name: 'Đi lại', icon: Car, textColor: 'text-orange-500', bgColor: 'bg-orange-100' },
  { id: '3', name: 'Ăn uống', icon: Utensils, textColor: 'text-red-500', bgColor: 'bg-red-100' },
  { id: '4', name: 'Nhà cửa', icon: Home, textColor: 'text-green-500', bgColor: 'bg-green-100' },
